            ...
            <div class="row">
                ...
                <?php
                    ...
                    if(isset($_GET['submit'])){
                        ...
                        mysqli_close($conn);
                        echo "เพิ่มสถานะโปรเจค $pst_name เรียบร้อยแล้ว<br>";
                        echo '<a href="project_status_list.php">แสดงสถานะโปรเจคทั้งหมด</a>';
                    }else{
                ...
                ?>
                    <form class="form-horizontal" role="form" name="title_edit" action="<?php echo $_SERVER['PHP_SELF']?>">
                        ...
                        <div class="form-group">
                            <label for="pst_name" class="col-md-2 col-lg-2 control-label">ชื่อสถานะโปรเจค</label>
